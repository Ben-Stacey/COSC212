 <?php
    $scriptList = array('./js/jquery-3.6.0.min.js', './js/reviews.js', './js/cart.js', './js/showHide.js', './js/cartDisplayJS.js');
    include("./htaccess/header.php");
 $_SESSION['lastPage'] = $_SERVER['PHP_SELF'];
 include("./htaccess/addReviewForm.php");
    ?>
    ...
    <main>
            ...
            <section class="film">
                ...
                <?php
                addReviewForm("./reviews/Attack_of_the_50ft_Women.xml");
                ?>
            </section>
